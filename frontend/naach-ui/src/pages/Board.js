...
export default function Board() {
  const committees = [
    // Executive Committee
    {
      ...
      icon: "🏮",
      description: "Leading the vision and strategic direction of NJ NAACH, ensuring every event creates waves of excitement and community impact.",
    ...
    },
    {
      ...
      icon: "🧭", 
      description: "Crafting the artistic vision and creative direction that makes NJ NAACH a unique and memorable experience for all.",
    ...
    // Operations Committee
    {
      ...
      icon: "🛟",
      description: "Ensuring smooth operations and logistics for every NJ NAACH event, from planning to execution with precision.",
    ...
    // Event Committee
    {
      ...
      icon: "🐚",
      description: "Orchestrating the flow of events and ensuring every moment of NJ NAACH is engaging and memorable for participants.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
    ...
    },
    {
      ...
      icon: "🏐",
      description: "Curating entertainment experiences and ensuring the energy stays high throughout the entire NJ NAACH event.",
      color: "from-beach-400 to-beach-500",
      textColor: "text-beach-100",
    ...
    // Marketing & Outreach
    {
      ...
      icon: "📢",
      description: "Spreading the word about NJ NAACH and building excitement for our events through creative marketing strategies.",
      color: "from-seafoam-400 to-seafoam-500",
      textColor: "text-seafoam-100",
    ...
    },
    {
      ...
      icon: "📸",
      description: "Managing our digital presence and engaging with the NJ NAACH community across all social media platforms.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
    ...
    // Support Committee
    {
      ...
      icon: "🛟",
      description: "Recruiting, training, and managing our amazing volunteers who make NJ NAACH events possible and successful.",
      color: "from-beach-400 to-beach-500",
      textColor: "text-beach-100",
    ...
    },
    {
      ...
      icon: "💎",
      description: "Building valuable partnerships with sponsors and securing resources to make NJ NAACH bigger and better each year.",
      color: "from-seafoam-400 to-seafoam-500",
      textColor: "text-seafoam-100",
    ...
    },
    {
      ...
      icon: "💙",
      description: "Leading our charitable initiatives and ensuring NJ NAACH makes a positive impact on the communities we serve.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
