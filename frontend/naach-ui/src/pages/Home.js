    ...
    <PageTemplate>
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-8 sm:mb-12 leading-tight drop-shadow-2xl animate-fade-in" 
              style={{ fontFamily: "'Baloo 2', cursive", color: "#FFE15D", textShadow: "2px 2px 4px rgba(0,0,0,0.3)" }}>
            NJ NAACH
            <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white drop-shadow-lg mt-2">3.0</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 lg:gap-12 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            <a 
              href="/schedule" 
              className="inline-block bg-gradient-to-r from-yellow-200 to-yellow-300 text-yellow-900 px-8 sm:px-12 lg:px-16 py-4 sm:py-5 lg:py-6 rounded-2xl sm:rounded-3xl text-base sm:text-lg lg:text-xl font-bold hover:from-yellow-300 hover:to-yellow-400 transform hover:scale-105 transition-all duration-300 font-ocean border-2 border-yellow-200 cursor-pointer no-underline"
            >
              EVENT SCHEDULE
            </a>
            ...
            <a 
              href="/teams" 
              className="inline-block bg-gradient-to-r from-blue-200 to-blue-300 text-blue-900 px-8 sm:px-12 lg:px-16 py-4 sm:py-5 lg:py-6 rounded-2xl sm:rounded-3xl text-base sm:text-lg lg:text-xl font-bold hover:from-blue-300 hover:to-blue-400 transform hover:scale-105 transition-all duration-300 font-ocean border-2 border-blue-200 cursor-pointer no-underline"
            >
              TEAMS INFO
            </a>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
              <div className="text-center md:text-left">
                ...
                <p className="text-base sm:text-lg text-beach-600 font-ocean mb-3 sm:mb-4 leading-relaxed">
                  ...
                  the premier event on the Jersey Shore.
                </p>
          ...
          <div className="mt-8 sm:mt-12 animate-slide-up" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
              <Button
                ...
                to="/tickets"
                size="lg"
                className="bg-gradient-to-r from-coral-400 to-coral-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-ocean font-semibold hover:from-coral-500 hover:to-coral-600 transform hover:scale-105 transition-all duration-300"
              >
                🎫 Get Your Tickets
              </Button>
              <Button
                ...
                size="lg"
                variant="bordered"
                className="border-2 border-beach-400 text-beach-600 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-ocean font-semibold hover:bg-beach-400 hover:text-white transform hover:scale-105 transition-all duration-300"
              >
                📅 View Schedule
              </Button>
            </div>
