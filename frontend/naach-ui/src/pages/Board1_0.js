...
export default function Board1_0() {
  const committees = [
    // Executive Committee
    {
      title: "Executive Director",
      icon: "🏮",
      description: "Leading the vision and strategic direction of NJ NAACH 1.0, ensuring every event creates waves of excitement and community impact.",
    ...
    },
    {
      ...
      icon: "🧭", 
      description: "Crafting the artistic vision and creative direction that makes NJ NAACH 1.0 a unique and memorable experience for all.",
    ...
    // Operations Committee
    {
      ...
      icon: "🛟",
      description: "Ensuring smooth operations and logistics for every NJ NAACH 1.0 event, from planning to execution with precision.",
    ...
    // Event Committee
    {
      ...
      icon: "🐚",
      description: "Orchestrating the flow of events and ensuring every moment of NJ NAACH 1.0 is engaging and memorable for participants.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
    ...
    },
    {
      ...
      icon: "🏐",
      description: "Curating entertainment experiences and ensuring the energy stays high throughout the entire NJ NAACH 1.0 event.",
      color: "from-beach-400 to-beach-500",
      textColor: "text-beach-100",
    ...
    // Marketing & Outreach
    {
      ...
      icon: "📢",
      description: "Spreading the word about NJ NAACH 1.0 and building excitement for our events through creative marketing strategies.",
      color: "from-seafoam-400 to-seafoam-500",
      textColor: "text-seafoam-100",
    ...
    },
    {
      ...
      icon: "📸",
      description: "Managing our digital presence and engaging with the NJ NAACH 1.0 community across all social media platforms.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
    ...
    // Support Committee
    {
      ...
      icon: "🛟",
      description: "Recruiting, training, and managing our amazing volunteers who make NJ NAACH 1.0 events possible and successful.",
      color: "from-beach-400 to-beach-500",
      textColor: "text-beach-100",
    ...
    },
    {
      ...
      icon: "💎",
      description: "Building valuable partnerships with sponsors and securing resources to make NJ NAACH 1.0 bigger and better each year.",
      color: "from-seafoam-400 to-seafoam-500",
      textColor: "text-seafoam-100",
    ...
    },
    {
      ...
      icon: "💙",
      description: "Leading our charitable initiatives and ensuring NJ NAACH 1.0 makes a positive impact on the communities we serve.",
      color: "from-sand-400 to-sand-500",
      textColor: "text-sand-100",
      ...
      <div className="bg-gradient-to-br from-beach-100 via-seafoam-100 to-sand-100 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-beach-600 font-ocean mb-6 sm:mb-8 animate-slide-up px-4">
            Meet the passionate leaders behind NJ NAACH 1.0
          </p>
